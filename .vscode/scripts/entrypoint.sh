...
# Set INSTALL_THEME default for local development, but respect .env file
if [ -z "$INSTALL_THEME" ]; then
  export INSTALL_THEME=1  # Default to True for local development
fi
...
###############################################
  ...
  EXCLUDED_TESTS="--test-tags=-/sale_management/tests/test_sale_ui.py:TestUi.test_03_sale_quote_tour,-/website/tests/test_automatic_editor.py:TestAutomaticEditor.test_01_automatic_editor_on_new_website,-:TestUi.test_website_sale_renting_comparison_ui,-.test_website_sale_subscription_product_variant_add_to_cart,-:TestIndustryFsmUi.test_ui,-/website_event_booth_exhibitor/tests/test_wevent_booth_exhibitor.py:TestWEventBoothExhibitorCommon.test_register,-:TestUi.test_15_website_link_tools,-:TestWebsiteSaleProductPage.test_toggle_contact_us_button_visibility,-/website_sale_wishlist/tests/test_wishlist_process.py:TestUi.test_01_wishlist_tour,-/website_sale_wishlist/tests/test_wishlist_process.py:TestWishlistProcess.test_01_wishlist_tour,-/knowledge/tests/test_knowledge_editor_commands.py:TestKnowledgeEditorCommands.test_knowledge_article_commands_tour,-/knowledge/tests/test_knowledge_editor_commands.py:TestKnowledgeEditorCommands.test_knowledge_calendar_command_tour,-/website_sale/tests/test_website_sale_image.py:TestWebsiteSaleRemoveImage.test_website_sale_add_and_remove_main_product_image_no_variant,-/website_sale/tests/test_website_sale_image.py:TestWebsiteSaleRemoveImage.test_website_sale_remove_main_product_image_with_variant,-/pos_restaurant_preparation_display/tests/test_frontend.py:TestUi.test_02_preparation_display_resto,-/pos_restaurant_preparation_display/tests/test_frontend.py:TestUi.test_payment_does_not_cancel_display_orders,-/website_sale_collect/tests/test_click_and_collect_flow.py:TestClickAndCollectFlow.test_buy_with_click_and_collect_as_public_user,-:TestUiPublisher.test_course_publisher_elearning_manager,-/website_sale/tests/test_website_sale_mail.py:TestWebsiteSaleMail.test_01_shop_mail_tour,-/test_website/tests/test_website_page_properties.py:TestWebsitePageProperties.test_website_page_properties_common,-:TestWebsitePageProperties.test_website_page_properties_website_page,-/sale_management/tests/test_sale_ui.py:TestUi.test_04_portal_sale_signature_without_name_tour,-/test_l10n_be_hr_payroll_account/tests/test_employee_job_change.py:TestEmployeeJobChange.test_employee_job_change,-/test_l10n_be_hr_payroll_account/tests/test_ui.py:Testl10nBeHrPayrollAccountUi.test_ui,-/website/tests/test_snippets.py:TestSnippets.test_03_snippets_all_drag_and_drop,-/website/tests/test_ui.py:TestUi.test_17_website_edit_menus,-/website_sale/tests/test_website_sale_add_to_cart_snippet.py:TestAddToCartSnippet.test_configure_product,-/mrp_workorder/tests/test_shopfloor.py:TestShopFloor.test_shop_floor,-:TestMigrateEmployeeWithContract,-:TestMigrateEmployee,-/website/tests/test_snippets.py:TestSnippets.test_snippet_popup_with_scrollbar_and_animations,-/l10n_es_edi_tbai/tests/test_17_5_tbai_document.py:TestEdiDocumentToTbaiDocument.test_prepare,-/l10n_au_hr_payroll_account/tests/test_single_touch_payroll.py:TestSingleTouchPayroll.test_stp_zeroing"
